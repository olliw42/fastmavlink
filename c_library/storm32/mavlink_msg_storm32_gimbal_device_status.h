...
//----------------------------------------
//-- Message STORM32_GIMBAL_DEVICE_STATUS pack,encode routines, for sending
//----------------------------------------
    ...
    fmav_status_t* _status)
{
    ...
    _msg->payload_max_len = FASTMAVLINK_MSG_STORM32_GIMBAL_DEVICE_STATUS_PAYLOAD_LEN_MAX;
...
//----------------------------------------
//-- Message STORM32_GIMBAL_DEVICE_STATUS decode routines, for receiving
//----------------------------------------
...
FASTMAVLINK_FUNCTION_DECORATOR void fmav_msg_storm32_gimbal_device_status_decode(fmav_storm32_gimbal_device_status_t* payload, const fmav_message_t* msg)
{
    ...
    if (msg->len < FASTMAVLINK_MSG_STORM32_GIMBAL_DEVICE_STATUS_PAYLOAD_LEN_MAX) {
        memset(&(((uint8_t*)payload)[msg->len]), 0, FASTMAVLINK_MSG_STORM32_GIMBAL_DEVICE_STATUS_PAYLOAD_LEN_MAX - msg->len);
    }
#else
