...
#define FASTMAVLINK_MSG_PARAM_EXT_REQUEST_LIST_PAYLOAD_LEN_MIN  2
#define FASTMAVLINK_MSG_PARAM_EXT_REQUEST_LIST_PAYLOAD_LEN_MAX  2
#define FASTMAVLINK_MSG_PARAM_EXT_REQUEST_LIST_PAYLOAD_LEN  2
#define FASTMAVLINK_MSG_PARAM_EXT_REQUEST_LIST_CRCEXTRA  88

#define FASTMAVLINK_MSG_ID_321_LEN_MIN  2
#define FASTMAVLINK_MSG_ID_321_LEN_MAX  2
#define FASTMAVLINK_MSG_ID_321_LEN  2
#define FASTMAVLINK_MSG_ID_321_CRCEXTRA  88
...
#define FASTMAVLINK_MSG_PARAM_EXT_REQUEST_LIST_FRAME_LEN_MAX  (FASTMAVLINK_HEADER_V2_LEN+FASTMAVLINK_MSG_PARAM_EXT_REQUEST_LIST_PAYLOAD_LEN_MAX+FASTMAVLINK_CHECKSUM_LEN+FASTMAVLINK_SIGNATURE_LEN)
#define FASTMAVLINK_MSG_ID_321_FRAME_LEN_MAX  (FASTMAVLINK_HEADER_V2_LEN+FASTMAVLINK_MSG_ID_321_PAYLOAD_LEN_MAX+FASTMAVLINK_CHECKSUM_LEN+FASTMAVLINK_SIGNATURE_LEN)
    ...
    fmav_status_t* _status)
{
    ...
    return fmav_finalize_msg(
        msg,
        FASTMAVLINK_MSG_PARAM_EXT_REQUEST_LIST_PAYLOAD_LEN_MIN,
...
{
    uint8_t len = (msg->len < FASTMAVLINK_MSG_PARAM_EXT_REQUEST_LIST_PAYLOAD_LEN_MAX) ? msg->len : FASTMAVLINK_MSG_PARAM_EXT_REQUEST_LIST_PAYLOAD_LEN_MAX;

    memset(payload, 0, FASTMAVLINK_MSG_PARAM_EXT_REQUEST_LIST_PAYLOAD_LEN_MAX);
