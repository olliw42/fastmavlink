...
//----------------------------------------
//-- Message ESC_TELEMETRY_9_TO_12 pack,encode routines, for sending
//----------------------------------------
...
{
    fmav_esc_telemetry_9_to_12_t* _payload = (fmav_esc_telemetry_9_to_12_t*)_msg->payload;
    ...
    _msg->sysid = sysid;
    _msg->compid = compid;
    _msg->msgid = FASTMAVLINK_MSG_ID_ESC_TELEMETRY_9_TO_12;
    _msg->target_sysid = 0;
    _msg->target_compid = 0;
    _msg->crc_extra = FASTMAVLINK_MSG_ESC_TELEMETRY_9_TO_12_CRCEXTRA;
    _msg->payload_max_len = FASTMAVLINK_MSG_ESC_TELEMETRY_9_TO_12_PAYLOAD_LEN_MAX;
...
FASTMAVLINK_FUNCTION_DECORATOR uint16_t fmav_msg_esc_telemetry_9_to_12_pack_to_frame_buf(
    ...
    fmav_status_t* _status)
{
    fmav_esc_telemetry_9_to_12_t* _payload = (fmav_esc_telemetry_9_to_12_t*)(&_buf[FASTMAVLINK_HEADER_V2_LEN]);
    ...
    _buf[5] = sysid;
    _buf[6] = compid;
    _buf[7] = (uint8_t)FASTMAVLINK_MSG_ID_ESC_TELEMETRY_9_TO_12;
    _buf[8] = ((uint32_t)FASTMAVLINK_MSG_ID_ESC_TELEMETRY_9_TO_12 >> 8);
    _buf[9] = ((uint32_t)FASTMAVLINK_MSG_ID_ESC_TELEMETRY_9_TO_12 >> 16);
...
//----------------------------------------
//-- Message ESC_TELEMETRY_9_TO_12 decode routines, for receiving
//----------------------------------------
