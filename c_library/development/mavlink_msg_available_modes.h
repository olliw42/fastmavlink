...
#define FASTMAVLINK_MSG_AVAILABLE_MODES_PAYLOAD_LEN_MAX  58
#define FASTMAVLINK_MSG_AVAILABLE_MODES_CRCEXTRA  94
...
#define FASTMAVLINK_MSG_AVAILABLE_MODES_FRAME_LEN_MAX  83

#define FASTMAVLINK_MSG_AVAILABLE_MODES_FIELD_MODE_NAME_NUM  50 // number of elements in array
#define FASTMAVLINK_MSG_AVAILABLE_MODES_FIELD_MODE_NAME_LEN  50 // length of array = number of bytes

#define FASTMAVLINK_MSG_AVAILABLE_MODES_FIELD_CUSTOM_MODE_OFS  0
#define FASTMAVLINK_MSG_AVAILABLE_MODES_FIELD_NUMBER_MODES_OFS  4
#define FASTMAVLINK_MSG_AVAILABLE_MODES_FIELD_MODE_INDEX_OFS  5
#define FASTMAVLINK_MSG_AVAILABLE_MODES_FIELD_STANDARD_MODE_OFS  6
#define FASTMAVLINK_MSG_AVAILABLE_MODES_FIELD_BASE_MODE_OFS  7
#define FASTMAVLINK_MSG_AVAILABLE_MODES_FIELD_MODE_NAME_OFS  8
    ...
    fmav_status_t* _status)
{
    ...
    memcpy(&(_payload->mode_name), mode_name, sizeof(char)*50);
    ...
    fmav_status_t* _status)
{
    return fmav_msg_available_modes_pack(
        _msg, sysid, compid,
        _payload->number_modes, _payload->mode_index, _payload->standard_mode, _payload->base_mode, _payload->custom_mode, _payload->mode_name,
        _status);
}
...
FASTMAVLINK_FUNCTION_DECORATOR uint8_t fmav_msg_available_modes_get_field_base_mode(const fmav_message_t* msg)
{
    uint8_t r;
    ...
    uint8_t number_modes, uint8_t mode_index, uint8_t standard_mode, uint8_t base_mode, uint32_t custom_mode, const char* mode_name)
{
    ...
    return fmav_msg_available_modes_pack(
        _msg, sysid, compid,
        number_modes, mode_index, standard_mode, base_mode, custom_mode, mode_name,
        _status);
}
