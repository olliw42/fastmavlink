...
#define FASTMAVLINK_MSG_MISSION_REQUEST_INT_PAYLOAD_LEN_MIN  4
#define FASTMAVLINK_MSG_MISSION_REQUEST_INT_PAYLOAD_LEN_MAX  5
#define FASTMAVLINK_MSG_MISSION_REQUEST_INT_PAYLOAD_LEN  5
#define FASTMAVLINK_MSG_MISSION_REQUEST_INT_CRCEXTRA  196

#define FASTMAVLINK_MSG_ID_51_LEN_MIN  4
#define FASTMAVLINK_MSG_ID_51_LEN_MAX  5
#define FASTMAVLINK_MSG_ID_51_LEN  5
#define FASTMAVLINK_MSG_ID_51_CRCEXTRA  196
...
#define FASTMAVLINK_MSG_MISSION_REQUEST_INT_FRAME_LEN_MAX  (FASTMAVLINK_HEADER_V2_LEN+FASTMAVLINK_MSG_MISSION_REQUEST_INT_PAYLOAD_LEN_MAX+FASTMAVLINK_CHECKSUM_LEN+FASTMAVLINK_SIGNATURE_LEN)
#define FASTMAVLINK_MSG_ID_51_FRAME_LEN_MAX  (FASTMAVLINK_HEADER_V2_LEN+FASTMAVLINK_MSG_ID_51_PAYLOAD_LEN_MAX+FASTMAVLINK_CHECKSUM_LEN+FASTMAVLINK_SIGNATURE_LEN)
    ...
    fmav_status_t* _status)
{
    ...
    return fmav_finalize_msg(
        msg,
        FASTMAVLINK_MSG_MISSION_REQUEST_INT_PAYLOAD_LEN_MIN,
...
FASTMAVLINK_FUNCTION_DECORATOR void fmav_msg_mission_request_int_decode(fmav_mission_request_int_t* payload, const fmav_message_t* msg)
{
    ...
    memset(payload, 0, FASTMAVLINK_MSG_MISSION_REQUEST_INT_PAYLOAD_LEN_MAX);
