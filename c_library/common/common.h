...
typedef enum GRIPPER_ACTIONS {
    ...
    GRIPPER_ACTIONS_ENUM_END = 3,  // end marker
} GRIPPER_ACTIONS;
#endif
...
typedef enum ORBIT_YAW_BEHAVIOUR {
    ...
    ORBIT_YAW_BEHAVIOUR_ENUM_END = 6,  // end marker
} ORBIT_YAW_BEHAVIOUR;
#endif
...
#ifndef FASTMAVLINK_HAS_ENUM_REBOOT_SHUTDOWN_ACTION
#define FASTMAVLINK_HAS_ENUM_REBOOT_SHUTDOWN_ACTION
typedef enum REBOOT_SHUTDOWN_ACTION {
    ...
    REBOOT_SHUTDOWN_ACTION_ENUM_END = 5,  // end marker
} REBOOT_SHUTDOWN_ACTION;
#endif


#ifndef FASTMAVLINK_HAS_ENUM_REBOOT_SHUTDOWN_CONDITIONS
#define FASTMAVLINK_HAS_ENUM_REBOOT_SHUTDOWN_CONDITIONS
typedef enum REBOOT_SHUTDOWN_CONDITIONS {
    ...
    REBOOT_SHUTDOWN_CONDITIONS_ENUM_END = 20190227,  // end marker
...
#ifndef FASTMAVLINK_HAS_ENUM_MAV_PARAM_ERROR
#define FASTMAVLINK_HAS_ENUM_MAV_PARAM_ERROR
typedef enum MAV_PARAM_ERROR {
    ...
    MAV_PARAM_ERROR_ENUM_END = 9,  // end marker
} MAV_PARAM_ERROR;
#endif
...
typedef enum MAV_RESULT {
    ...
    MAV_RESULT_ENUM_END = 11,  // end marker
} MAV_RESULT;
#endif
...
#ifndef FASTMAVLINK_HAS_ENUM_MAV_FUEL_TYPE
#define FASTMAVLINK_HAS_ENUM_MAV_FUEL_TYPE
typedef enum MAV_FUEL_TYPE {
    ...
    MAV_FUEL_TYPE_ENUM_END = 3,  // end marker
} MAV_FUEL_TYPE;
#endif
...
typedef enum MAV_DO_REPOSITION_FLAGS {
    ...
    MAV_DO_REPOSITION_FLAGS_ENUM_END = 3,  // end marker
...
typedef enum CAMERA_CAP_FLAGS {
    ...
    CAMERA_CAP_FLAGS_ENUM_END = 8193,  // end marker
} CAMERA_CAP_FLAGS;
#endif
...
typedef enum VIDEO_STREAM_STATUS_FLAGS {
    ...
    VIDEO_STREAM_STATUS_FLAGS_ENUM_END = 5,  // end marker
...
#ifndef FASTMAVLINK_HAS_ENUM_VIDEO_STREAM_ENCODING
#define FASTMAVLINK_HAS_ENUM_VIDEO_STREAM_ENCODING
typedef enum VIDEO_STREAM_ENCODING {
    ...
    VIDEO_STREAM_ENCODING_ENUM_END = 3,  // end marker
...
typedef enum CAMERA_TRACKING_STATUS_FLAGS {
    ...
    CAMERA_TRACKING_STATUS_FLAGS_ENUM_END = 9,  // end marker
...
#ifndef FASTMAVLINK_HAS_ENUM_RC_SUB_TYPE
#define FASTMAVLINK_HAS_ENUM_RC_SUB_TYPE
typedef enum RC_SUB_TYPE {
    ...
    RC_SUB_TYPE_ENUM_END = 3,  // end marker
} RC_SUB_TYPE;
#endif


#ifndef FASTMAVLINK_HAS_ENUM_ENGINE_CONTROL_OPTIONS
#define FASTMAVLINK_HAS_ENUM_ENGINE_CONTROL_OPTIONS
typedef enum ENGINE_CONTROL_OPTIONS {
    ...
    ENGINE_CONTROL_OPTIONS_ENUM_END = 2,  // end marker
...
typedef enum MAV_TUNNEL_PAYLOAD_TYPE {
    ...
    MAV_TUNNEL_PAYLOAD_TYPE_ENUM_END = 213,  // end marker
...
typedef enum HIGHRES_IMU_UPDATED_FLAGS {
    ...
    HIGHRES_IMU_UPDATED_FLAGS_ENUM_END = 4097,  // end marker
...
typedef enum MAV_STANDARD_MODE {
    ...
    MAV_STANDARD_MODE_SAFE_RECOVERY = 5,  // Safe recovery mode (auto).          Automatic mode that takes vehicle to a predefined safe location via a safe flight path, and may also automatically land the vehicle.          This mode is more commonly referred to as RTL and/or or Smart RTL.          The precise return location, flight path, and landing behaviour depend on vehicle configuration and type.          For example, the vehicle might return to the home/launch location, a rally point, or the start of a mission landing, it might follow a direct path, mission path, or breadcrumb path, and land using a mission landing pattern or some other kind of descent.         
    MAV_STANDARD_MODE_MISSION = 6,  // Mission mode (automatic).          Automatic mode that executes MAVLink missions.          Missions are executed from the current waypoint as soon as the mode is enabled.         
    MAV_STANDARD_MODE_LAND = 7,  // Land mode (auto).          Automatic mode that lands the vehicle at the current location.          The precise landing behaviour depends on vehicle configuration and type.         
    MAV_STANDARD_MODE_TAKEOFF = 8,  // Takeoff mode (auto).          Automatic takeoff mode.          The precise takeoff behaviour depends on vehicle configuration and type.         
    MAV_STANDARD_MODE_ENUM_END = 9,  // end marker
} MAV_STANDARD_MODE;
#endif


#ifndef FASTMAVLINK_HAS_ENUM_MAV_MODE_PROPERTY
#define FASTMAVLINK_HAS_ENUM_MAV_MODE_PROPERTY
typedef enum MAV_MODE_PROPERTY {
    ...
    MAV_MODE_PROPERTY_ENUM_END = 5,  // end marker
} MAV_MODE_PROPERTY;
#endif


#ifndef FASTMAVLINK_HAS_ENUM_HIL_ACTUATOR_CONTROLS_FLAGS
#define FASTMAVLINK_HAS_ENUM_HIL_ACTUATOR_CONTROLS_FLAGS
typedef enum HIL_ACTUATOR_CONTROLS_FLAGS {
    HIL_ACTUATOR_CONTROLS_FLAGS_LOCKSTEP = 1,  // Simulation is using lockstep 
    HIL_ACTUATOR_CONTROLS_FLAGS_ENUM_END = 2,  // end marker
} HIL_ACTUATOR_CONTROLS_FLAGS;
#endif


#ifndef FASTMAVLINK_HAS_ENUM_COMPUTER_STATUS_FLAGS
#define FASTMAVLINK_HAS_ENUM_COMPUTER_STATUS_FLAGS
typedef enum COMPUTER_STATUS_FLAGS {
    ...
    COMPUTER_STATUS_FLAGS_ENUM_END = 9,  // end marker
...
typedef enum AIRSPEED_SENSOR_FLAGS {
    ...
    AIRSPEED_SENSOR_FLAGS_ENUM_END = 3,  // end marker
