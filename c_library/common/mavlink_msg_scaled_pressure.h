...
#define FASTMAVLINK_MSG_SCALED_PRESSURE_PAYLOAD_LEN_MIN  14
#define FASTMAVLINK_MSG_SCALED_PRESSURE_PAYLOAD_LEN_MAX  16
#define FASTMAVLINK_MSG_SCALED_PRESSURE_PAYLOAD_LEN  16
#define FASTMAVLINK_MSG_SCALED_PRESSURE_CRCEXTRA  115

#define FASTMAVLINK_MSG_ID_29_LEN_MIN  14
#define FASTMAVLINK_MSG_ID_29_LEN_MAX  16
#define FASTMAVLINK_MSG_ID_29_LEN  16
#define FASTMAVLINK_MSG_ID_29_CRCEXTRA  115
...
#define FASTMAVLINK_MSG_SCALED_PRESSURE_FRAME_LEN_MAX  (FASTMAVLINK_HEADER_V2_LEN+FASTMAVLINK_MSG_SCALED_PRESSURE_PAYLOAD_LEN_MAX+FASTMAVLINK_CHECKSUM_LEN+FASTMAVLINK_SIGNATURE_LEN)
#define FASTMAVLINK_MSG_ID_29_FRAME_LEN_MAX  (FASTMAVLINK_HEADER_V2_LEN+FASTMAVLINK_MSG_ID_29_PAYLOAD_LEN_MAX+FASTMAVLINK_CHECKSUM_LEN+FASTMAVLINK_SIGNATURE_LEN)
    ...
    fmav_status_t* _status)
{
    ...
    return fmav_finalize_msg(
        msg,
        FASTMAVLINK_MSG_SCALED_PRESSURE_PAYLOAD_LEN_MIN,
...
{
    uint8_t len = (msg->len < FASTMAVLINK_MSG_SCALED_PRESSURE_PAYLOAD_LEN_MAX) ? msg->len : FASTMAVLINK_MSG_SCALED_PRESSURE_PAYLOAD_LEN_MAX;

    memset(payload, 0, FASTMAVLINK_MSG_SCALED_PRESSURE_PAYLOAD_LEN_MAX);
