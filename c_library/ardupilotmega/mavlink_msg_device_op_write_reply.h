...
#define FASTMAVLINK_MSG_DEVICE_OP_WRITE_REPLY_PAYLOAD_LEN_MIN  5
#define FASTMAVLINK_MSG_DEVICE_OP_WRITE_REPLY_PAYLOAD_LEN_MAX  5
#define FASTMAVLINK_MSG_DEVICE_OP_WRITE_REPLY_PAYLOAD_LEN  5
#define FASTMAVLINK_MSG_DEVICE_OP_WRITE_REPLY_CRCEXTRA  64

#define FASTMAVLINK_MSG_ID_11003_LEN_MIN  5
#define FASTMAVLINK_MSG_ID_11003_LEN_MAX  5
#define FASTMAVLINK_MSG_ID_11003_LEN  5
#define FASTMAVLINK_MSG_ID_11003_CRCEXTRA  64
...
#define FASTMAVLINK_MSG_DEVICE_OP_WRITE_REPLY_FRAME_LEN_MAX  (FASTMAVLINK_HEADER_V2_LEN+FASTMAVLINK_MSG_DEVICE_OP_WRITE_REPLY_PAYLOAD_LEN_MAX+FASTMAVLINK_CHECKSUM_LEN+FASTMAVLINK_SIGNATURE_LEN)
#define FASTMAVLINK_MSG_ID_11003_FRAME_LEN_MAX  (FASTMAVLINK_HEADER_V2_LEN+FASTMAVLINK_MSG_ID_11003_PAYLOAD_LEN_MAX+FASTMAVLINK_CHECKSUM_LEN+FASTMAVLINK_SIGNATURE_LEN)


//----------------------------------------
//-- Message DEVICE_OP_WRITE_REPLY packing routines, for sending
//----------------------------------------
...
{
    fmav_device_op_write_reply_t* _payload = (fmav_device_op_write_reply_t*)msg->payload;
    ...
    msg->sysid = sysid;
    msg->compid = compid;
    msg->msgid = FASTMAVLINK_MSG_ID_DEVICE_OP_WRITE_REPLY;

    msg->target_sysid = 0;
    msg->target_compid = 0;
    msg->crc_extra = FASTMAVLINK_MSG_DEVICE_OP_WRITE_REPLY_CRCEXTRA;

    return fmav_finalize_msg(
        msg,
        FASTMAVLINK_MSG_DEVICE_OP_WRITE_REPLY_PAYLOAD_LEN_MIN,
...
FASTMAVLINK_FUNCTION_DECORATOR uint16_t fmav_msg_device_op_write_reply_pack_to_frame_buf(
    ...
    fmav_status_t* _status)
{
    fmav_device_op_write_reply_t* _payload = (fmav_device_op_write_reply_t*)(&buf[FASTMAVLINK_HEADER_V2_LEN]);
    ...
    buf[5] = sysid;
    buf[6] = compid;
    buf[7] = (uint8_t)FASTMAVLINK_MSG_ID_DEVICE_OP_WRITE_REPLY;
    buf[8] = ((uint32_t)FASTMAVLINK_MSG_ID_DEVICE_OP_WRITE_REPLY >> 8);
    buf[9] = ((uint32_t)FASTMAVLINK_MSG_ID_DEVICE_OP_WRITE_REPLY >> 16);
...
//----------------------------------------
//-- Message DEVICE_OP_WRITE_REPLY unpacking routines, for receiving
//----------------------------------------
...
{
    uint8_t len = (msg->len < FASTMAVLINK_MSG_DEVICE_OP_WRITE_REPLY_PAYLOAD_LEN_MAX) ? msg->len : FASTMAVLINK_MSG_DEVICE_OP_WRITE_REPLY_PAYLOAD_LEN_MAX;

    memset(payload, 0, FASTMAVLINK_MSG_DEVICE_OP_WRITE_REPLY_PAYLOAD_LEN_MAX);
