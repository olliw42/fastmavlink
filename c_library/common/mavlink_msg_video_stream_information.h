...
FASTMAVLINK_FUNCTION_DECORATOR uint8_t fmav_msg_video_stream_information_get_field_encoding(const fmav_message_t* msg)
{
    uint8_t r;
    memcpy(&r, &(msg->payload[213]), sizeof(uint8_t));
    return r;
}
