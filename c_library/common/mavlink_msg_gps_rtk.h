...
#define FASTMAVLINK_MSG_GPS_RTK_PAYLOAD_LEN_MIN  35
#define FASTMAVLINK_MSG_GPS_RTK_PAYLOAD_LEN_MAX  35
#define FASTMAVLINK_MSG_GPS_RTK_PAYLOAD_LEN  35
#define FASTMAVLINK_MSG_GPS_RTK_CRCEXTRA  25

#define FASTMAVLINK_MSG_ID_127_LEN_MIN  35
#define FASTMAVLINK_MSG_ID_127_LEN_MAX  35
#define FASTMAVLINK_MSG_ID_127_LEN  35
#define FASTMAVLINK_MSG_ID_127_CRCEXTRA  25
...
#define FASTMAVLINK_MSG_GPS_RTK_FRAME_LEN_MAX  (FASTMAVLINK_HEADER_V2_LEN+FASTMAVLINK_MSG_GPS_RTK_PAYLOAD_LEN_MAX+FASTMAVLINK_CHECKSUM_LEN+FASTMAVLINK_SIGNATURE_LEN)
#define FASTMAVLINK_MSG_ID_127_FRAME_LEN_MAX  (FASTMAVLINK_HEADER_V2_LEN+FASTMAVLINK_MSG_ID_127_PAYLOAD_LEN_MAX+FASTMAVLINK_CHECKSUM_LEN+FASTMAVLINK_SIGNATURE_LEN)
    ...
    fmav_status_t* _status)
{
    ...
    return fmav_finalize_msg(
        msg,
        FASTMAVLINK_MSG_GPS_RTK_PAYLOAD_LEN_MIN,
...
{
    uint8_t len = (msg->len < FASTMAVLINK_MSG_GPS_RTK_PAYLOAD_LEN_MAX) ? msg->len : FASTMAVLINK_MSG_GPS_RTK_PAYLOAD_LEN_MAX;

    memset(payload, 0, FASTMAVLINK_MSG_GPS_RTK_PAYLOAD_LEN_MAX);
