...
//----------------------------------------
//-- Message STORM32_GIMBAL_MANAGER_INFORMATION pack,encode routines, for sending
//----------------------------------------
...
{
    fmav_storm32_gimbal_manager_information_t* _payload = (fmav_storm32_gimbal_manager_information_t*)_msg->payload;
    ...
    _msg->sysid = sysid;
    _msg->compid = compid;
    _msg->msgid = FASTMAVLINK_MSG_ID_STORM32_GIMBAL_MANAGER_INFORMATION;
    _msg->target_sysid = 0;
    _msg->target_compid = 0;
    _msg->crc_extra = FASTMAVLINK_MSG_STORM32_GIMBAL_MANAGER_INFORMATION_CRCEXTRA;
    _msg->payload_max_len = FASTMAVLINK_MSG_STORM32_GIMBAL_MANAGER_INFORMATION_PAYLOAD_LEN_MAX;
...
FASTMAVLINK_FUNCTION_DECORATOR uint16_t fmav_msg_storm32_gimbal_manager_information_pack_to_frame_buf(
    ...
    fmav_status_t* _status)
{
    fmav_storm32_gimbal_manager_information_t* _payload = (fmav_storm32_gimbal_manager_information_t*)(&_buf[FASTMAVLINK_HEADER_V2_LEN]);
    ...
    _buf[5] = sysid;
    _buf[6] = compid;
    _buf[7] = (uint8_t)FASTMAVLINK_MSG_ID_STORM32_GIMBAL_MANAGER_INFORMATION;
    _buf[8] = ((uint32_t)FASTMAVLINK_MSG_ID_STORM32_GIMBAL_MANAGER_INFORMATION >> 8);
    _buf[9] = ((uint32_t)FASTMAVLINK_MSG_ID_STORM32_GIMBAL_MANAGER_INFORMATION >> 16);
...
//----------------------------------------
//-- Message STORM32_GIMBAL_MANAGER_INFORMATION decode routines, for receiving
//----------------------------------------
