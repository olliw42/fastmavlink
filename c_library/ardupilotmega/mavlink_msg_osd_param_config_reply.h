...
#define FASTMAVLINK_MSG_OSD_PARAM_CONFIG_REPLY_PAYLOAD_LEN_MIN  5
#define FASTMAVLINK_MSG_OSD_PARAM_CONFIG_REPLY_PAYLOAD_LEN_MAX  5
#define FASTMAVLINK_MSG_OSD_PARAM_CONFIG_REPLY_PAYLOAD_LEN  5
#define FASTMAVLINK_MSG_OSD_PARAM_CONFIG_REPLY_CRCEXTRA  79

#define FASTMAVLINK_MSG_ID_11034_LEN_MIN  5
#define FASTMAVLINK_MSG_ID_11034_LEN_MAX  5
#define FASTMAVLINK_MSG_ID_11034_LEN  5
#define FASTMAVLINK_MSG_ID_11034_CRCEXTRA  79
...
#define FASTMAVLINK_MSG_OSD_PARAM_CONFIG_REPLY_FRAME_LEN_MAX  (FASTMAVLINK_HEADER_V2_LEN+FASTMAVLINK_MSG_OSD_PARAM_CONFIG_REPLY_PAYLOAD_LEN_MAX+FASTMAVLINK_CHECKSUM_LEN+FASTMAVLINK_SIGNATURE_LEN)
#define FASTMAVLINK_MSG_ID_11034_FRAME_LEN_MAX  (FASTMAVLINK_HEADER_V2_LEN+FASTMAVLINK_MSG_ID_11034_PAYLOAD_LEN_MAX+FASTMAVLINK_CHECKSUM_LEN+FASTMAVLINK_SIGNATURE_LEN)
    ...
    fmav_status_t* _status)
{
    ...
    return fmav_finalize_msg(
        msg,
        FASTMAVLINK_MSG_OSD_PARAM_CONFIG_REPLY_PAYLOAD_LEN_MIN,
...
{
    uint8_t len = (msg->len < FASTMAVLINK_MSG_OSD_PARAM_CONFIG_REPLY_PAYLOAD_LEN_MAX) ? msg->len : FASTMAVLINK_MSG_OSD_PARAM_CONFIG_REPLY_PAYLOAD_LEN_MAX;

    memset(payload, 0, FASTMAVLINK_MSG_OSD_PARAM_CONFIG_REPLY_PAYLOAD_LEN_MAX);
