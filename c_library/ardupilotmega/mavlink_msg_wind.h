...
//----------------------------------------
//-- Message WIND pack,encode routines, for sending
//----------------------------------------
...
{
    fmav_wind_t* _payload = (fmav_wind_t*)_msg->payload;
    ...
    _msg->sysid = sysid;
    _msg->compid = compid;
    _msg->msgid = FASTMAVLINK_MSG_ID_WIND;
    _msg->target_sysid = 0;
    _msg->target_compid = 0;
    _msg->crc_extra = FASTMAVLINK_MSG_WIND_CRCEXTRA;
    _msg->payload_max_len = FASTMAVLINK_MSG_WIND_PAYLOAD_LEN_MAX;
...
FASTMAVLINK_FUNCTION_DECORATOR uint16_t fmav_msg_wind_pack_to_frame_buf(
    ...
    fmav_status_t* _status)
{
    fmav_wind_t* _payload = (fmav_wind_t*)(&_buf[FASTMAVLINK_HEADER_V2_LEN]);
    ...
    _buf[5] = sysid;
    _buf[6] = compid;
    _buf[7] = (uint8_t)FASTMAVLINK_MSG_ID_WIND;
    _buf[8] = ((uint32_t)FASTMAVLINK_MSG_ID_WIND >> 8);
    _buf[9] = ((uint32_t)FASTMAVLINK_MSG_ID_WIND >> 16);
...
//----------------------------------------
//-- Message WIND decode routines, for receiving
//----------------------------------------
