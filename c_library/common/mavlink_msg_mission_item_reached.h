...
#define FASTMAVLINK_MSG_MISSION_ITEM_REACHED_PAYLOAD_LEN  2
#define FASTMAVLINK_MSG_MISSION_ITEM_REACHED_CRCEXTRA  11

#define FASTMAVLINK_MSG_ID_46_LEN_MIN  2
#define FASTMAVLINK_MSG_ID_46_LEN_MAX  2
#define FASTMAVLINK_MSG_ID_46_LEN  2
#define FASTMAVLINK_MSG_ID_46_CRCEXTRA  11
...
#define FASTMAVLINK_MSG_MISSION_ITEM_REACHED_FRAME_LEN_MAX  (FASTMAVLINK_HEADER_V2_LEN+FASTMAVLINK_MSG_MISSION_ITEM_REACHED_PAYLOAD_LEN_MAX+FASTMAVLINK_CHECKSUM_LEN+FASTMAVLINK_SIGNATURE_LEN)
#define FASTMAVLINK_MSG_ID_46_FRAME_LEN_MAX  (FASTMAVLINK_HEADER_V2_LEN+FASTMAVLINK_MSG_ID_46_PAYLOAD_LEN_MAX+FASTMAVLINK_CHECKSUM_LEN+FASTMAVLINK_SIGNATURE_LEN)
